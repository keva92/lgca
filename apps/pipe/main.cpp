...
int main(int argc, char **argv) {
    ...
    if (parallel_type == "CUDA") {
        ...
        lattice = new CUDA_Lattice(/*case=*/"pipe", Re, Ma, n_dir, coarse_graining_radius, device);

    } else if (parallel_type == "OMP") {

        lattice = new OMP_Lattice(/*case=*/"pipe", Re, Ma, n_dir, coarse_graining_radius);
    ...
    lgca::IoVti vtiIoHandler(lattice, "Mean density");
