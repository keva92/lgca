    ...
    m_ui(new Ui::BoxView)
{
    ...
    m_lattice = new OMP_Lattice<MODEL>(/*case=*/"box", m_Re, m_Ma, CG_RADIUS);
...
//    m_lut->SetTableValue(0, 0.0, 0.0, 0.5625);
//    m_lut->SetTableValue(1, 0.0, 0.0, 1.0);
//    m_lut->SetTableValue(2, 0.0, 1.0, 1.0);
//    m_lut->SetTableValue(3, 0.5, 1.0, 0.5);
//    m_lut->SetTableValue(4, 1.0, 1.0, 0.0);
//    m_lut->SetTableValue(5, 1.0, 0.0, 0.0);
//    m_lut->SetTableValue(6, 0.5, 0.0, 0.0);
